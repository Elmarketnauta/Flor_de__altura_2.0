      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid gap-12 lg:grid-cols-2">
          ...
          <motion.div
            ...
            className="relative"
          >
            {/* Altitud — siempre visible, elemento de marca */}
          ...
          >
                    ...
                    <div className="border-t border-sand px-5 py-5 space-y-4 bg-white">
                      <dl className="grid grid-cols-2 gap-x-6 gap-y-3 text-sm">
                        <div>
                          ...
                          <dd className="mt-0.5 font-semibold text-espresso-800">
                            {product.altitude.toLocaleString()} msnm
                          </dd>
                        </div>
                        <div>
                        ...
                        {product.botanicalVariety && (
                          <div>
                            ...
                            <dd className="mt-0.5 font-semibold text-espresso-800 text-xs leading-snug">
                              {product.botanicalVariety}
                            </dd>
                          </div>
                        )}
                          ...
                          <div>
                            ...
                            <dd className="mt-0.5">
                              {product.fincaSlug ? (
                                <Link
                                  href={`/fincas/${product.fincaSlug}`}
                                  className="font-semibold text-organic hover:underline"
                                >
                                  {product.fincaName}
                                </Link>
                              ) : (
                      ...
                      {product.cupProfile && (
                        <div className="pt-2 border-t border-sand">
                          <p className="font-mono text-xs uppercase tracking-wide text-espresso-400 mb-2">
                            Perfil de taza
                          </p>
            ...
            <div className="rounded-2xl border border-sand bg-white p-5 space-y-4">
              ...
              >
                <div>
                  <p className="text-xs font-mono uppercase tracking-wide text-gold">
                    Club Flor de Altura
                  </p>
        ...
        {/* ── Productos relacionados de la misma finca ── */}
        {related.length > 0 && (
        ...
        {product.fincaSlug && (
          ...
          >
            ...
            <h2 className="font-serif text-3xl text-cream">
              Conoce {product.fincaName}
            </h2>
            <p className="mt-3 text-espresso-200 max-w-xl mx-auto">
              Cada taza tiene historia. Descubre la finca, el productor y el
              territorio donde nace este café excepcional.
            </p>
            <Link
              href={`/fincas/${product.fincaSlug}`}
